...
namespace PixelCounter
{
    static class LegoColorBase
    {
        static LegoColorBase()
        {
            ...
            AllColors.Add(new LegoColor("Pink", "Lilac", "FC97AC"));
            AllColors.Add(new LegoColor("Coral", "Lilac", "FF698F"));
            AllColors.Add(new LegoColor("Bright Pink", "Lilac", "E4ADC8"));
            ...
            AllColors.Add(new LegoColor("Blue", "Blue", "0055BF"));
            AllColors.Add(new LegoColor("Dark Blue", "Blue", "0A3463"));
            #endregion
            ...
            //AllColors.Add(new LegoColor("xxxx", "xxxx", "xxxxx", Color.FromArgb(0,0,0)));
            AllColors.Add(new LegoColor("Dark Green", "Green", "184632", Color.FromArgb(24, 70, 50)));
            AllColors.Add(new LegoColor("Medium Green", "Green", "73DCA1", Color.FromArgb(115, 220, 161)));
            AllColors.Add(new LegoColor("Green", "Green", "237841"));
            AllColors.Add(new LegoColor("Lime", "Green", "BBE90B"));
            #endregion
            ...
            AllColors.Add(new LegoColor("Yellow", "Yellow", "F2CD37"));
            AllColors.Add(new LegoColor("Light Yellow", "Yellow", "FBE696"));
            #endregion
            ...
            AllColors.Add(new LegoColor("Red", "Red", "C91A09"));
            #endregion
            ...
            #region Silver
            AllColors.Add(new LegoColor("Flat Silver", "Silver", "898788"));
            #endregion
